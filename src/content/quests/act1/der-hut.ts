...
export const derHut: QuestDef = {
  ...
  historical: 'legend', note: "Wholly L (Weisses Buch von Sarnen c. 1470 / Tschudi): the hat, the apple shot, the Tellsplatte leap, Gessler's death in the Hohle Gasse. The game dates it 1307 per Tschudi and says so in the journal. LORE.md §1/§6.",
  ...
  stages: [
    {
      id: 'altdorf-pole', journal: "Sixteen years since the Rütli. Gessler's hat sits on a pole by the Altdorf lime tree, and every man is made to bow to it.",
    ...
    {
      id: 'tellsplatte', journal: 'Arrested regardless, Tell is carried toward Küssnacht by boat — until a storm on the Urnersee gives him his chance.',
      marker: 'poi.tellsplatte', objectiveText: 'Follow the storm to the Tellsplatte.',
    ...
    {
      id: 'epilogue', journal: 'The bailiffs are gone from Uri, Schwyz and Unterwalden.',
      onEnter: [
