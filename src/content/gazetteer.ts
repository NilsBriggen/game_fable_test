...
export const PLACES: Record<string, GazetteerPlace> = {
  ...
  'andermatt': { id: 'andermatt', name: 'Andermatt', x: -270, z: 8155, kind: 'village', owner: 'uri', asl: 1440, h: 335 },
  'hospental': { id: 'hospental', name: 'Hospental', x: -676, z: 8525, kind: 'village', owner: 'uri', asl: 1450, h: 339 },
  ...
  'zug': { id: 'zug', name: 'Zug', x: -1588, z: -5016, kind: 'town', owner: 'habsburg', asl: 420, h: -5 },
  'baar': { id: 'baar', name: 'Baar', x: -1402, z: -5708, kind: 'village', owner: 'habsburg', asl: 440, h: 2 },
  ...
  'kuessnacht': { id: 'kuessnacht', name: 'Küssnacht', x: -2837, z: -2990, kind: 'village', owner: 'habsburg', asl: 440, h: 2 },
...
export const RIVERS: { id: string; name: string; via: string[] }[] = [
  ...
  { id: 'lorze', name: 'Lorze', via: ["unteraegeri", "baar", "zug"] },
];
...
export const ROADS: { id: string; name: string; via: string[] }[] = [
  ...
  { id: 'sattel-road', name: 'Steinen–Sattel–Ägeri (Morgarten road)', via: ["steinen", "steinerberg", "sattel", "sattel-letzi", "morgarten", "oberaegeri", "unteraegeri", "baar", "zug"] },
  { id: 'arth-road', name: 'Schwyz–Arth–Zug', via: ["seewen", "goldau", "arth", "zug"] },
